# Module 3: R studio server install dependencies
...
5. This will open a script on the left hand side – go ahead and just run the script. Installation time is about 10-20 minutes. We will     do :doc:`BIBSnet_volumetric_analysis_on_jupyter_notebooks` in the meantime.
<img src="../images/module3/image7.png" alt="Study Target Progress" width="70%" height="auto" class="center">
