<h1><i class="fa-brands fa-codepen"></i> Welcome to the HDCC Sandbox Tutorial Series!</h1>
...
The **[NBDC Data Access Platform](https://nbdc-datashare.lassoinformatics.com/)** provides a centralized portal where researchers can explore, search, request access to, and download datasets, including releases from the **[HBCD](https://hbcdstudy.org/)** and **[ABCD](https://abcdstudy.org/)** studies.
